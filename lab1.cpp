...
void render()
{
    ...
    // If the window width is less than 40, don't draw the box
    if (g.xres < 40) {
        glColor3ub(30, 30, 30);
    }
    // Set the box color red if < 400
    else if (g.xres < 400) {
        glColor3ub(255, 0, 0);
    }
    // Set the box color blue
    else {
    ...
    // If the window is too small, nothing will be drawn
}
